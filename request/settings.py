...
REQUEST_IGNORE_SELF_REFERER = getattr(settings, 'REQUEST_IGNORE_SELF_REFERER', True)
REQUEST_IGNORE_BLANK_REFERER = getattr(settings, 'REQUEST_IGNORE_BLANK_REFERER', True)
